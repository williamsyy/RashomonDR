"""Autoencoder related submodules.

This file is modified from https://github.com/BorgwardtLab/topological-autoencoders
as well as https://github.com/sciai-lab/GeometricAutoencoder.
"""
import abc
...
class BoxAutoEncoder(AutoencoderModel):
    ...
    def __init__(self, input_dims=(1, 28, 28), output_dim=2,
        ...
        self.reconst_error = nn.MSELoss().to(device)
