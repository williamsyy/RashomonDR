...
import parampacmap.models.ae_submodules as submodules
from parampacmap.models.ae_helpers import DeterminantLoss, PersistentHomologyCalculation


class GeometricAutoencoder(submodules.AutoencoderModel):
    """Geometrically regularized autoencoder."""

    def __init__(self, lam=1., autoencoder_model='BoxAutoEncoder',
...
class TopologicallyRegularizedAutoencoder(submodules.AutoencoderModel):
    ...
    def forward(self, x):
        ...
        if self.with_geom_loss:
            ...
            loss_components.update({"loss.geom_error": det_loss})
